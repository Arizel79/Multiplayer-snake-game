...
async def run_client():
    parser = argparse.ArgumentParser(
        description="Multiplayer Snake game CLI/GUI edition"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        choices=["cli", "gui"],
        help="Game mode (cli/gui)",
        default=game_config["run_mode"],
    )
    parser.add_argument(
        "--name", "--n", type=str, help="Snake name", default=game_config["player"]
    )
    parser.add_argument(
        "--color", "--c", type=str, help="Snake color", default=game_config["color"]
    )
    parser.add_argument(
        "--server",
        "--s",
    ...
    parser.add_argument(
        "--use_main_menu",
        "--menu",
        default=game_config["use_main_menu"],
        action="store_true",
        help="Enable interactive main menu (default: False)",
    )
    ...
    if args.mode == "cli":
        g = ClientCLI(
            ...
            args.name,
            args.color,
            use_main_menu=args.use_main_menu,
            logging_level=args.log_lvl,
        )
    elif args.mode == "gui":
        g = ClientGUI(
            GAME_CONFIG_FILENAME,
